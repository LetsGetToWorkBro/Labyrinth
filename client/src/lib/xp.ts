...
export const XP_LEVELS = [
  ...
  { level: 11, xpRequired: 3250,  title: 'Seasoned Warrior' },
  { level: 12, xpRequired: 3850,  title: 'Seasoned Warrior' },
  { level: 13, xpRequired: 4500,  title: 'Seasoned Warrior' },
  { level: 14, xpRequired: 5200,  title: 'Seasoned Warrior' },
  { level: 15, xpRequired: 6000,  title: 'Gym Pillar' },
  { level: 16, xpRequired: 6900,  title: 'Gym Pillar' },
  { level: 17, xpRequired: 7900,  title: 'Gym Pillar' },
  { level: 18, xpRequired: 9000,  title: 'Gym Pillar' },
  { level: 19, xpRequired: 10200, title: 'Gym Pillar' },
  { level: 20, xpRequired: 11500, title: 'Labyrinth Veteran' },
  { level: 21, xpRequired: 12900, title: 'Labyrinth Veteran' },
  { level: 22, xpRequired: 14400, title: 'Labyrinth Veteran' },
  { level: 23, xpRequired: 16000, title: 'Labyrinth Veteran' },
  { level: 24, xpRequired: 17700, title: 'Labyrinth Veteran' },
  { level: 25, xpRequired: 19500, title: 'Elite Grappler' },
  { level: 26, xpRequired: 21500, title: 'Elite Grappler' },
  { level: 27, xpRequired: 23700, title: 'Elite Grappler' },
  { level: 28, xpRequired: 26100, title: 'Elite Grappler' },
  { level: 29, xpRequired: 28700, title: 'Elite Grappler' },
  { level: 30, xpRequired: 31500, title: 'Legend of the Mat' },
  { level: 40, xpRequired: 60000, title: 'Paragon' },
  { level: 50, xpRequired: 100000, title: 'Grandmaster Paragon' },
];
